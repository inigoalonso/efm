...
function main(graphContainer) {
    ...
    if (!mxClient.isBrowserSupported()) {
        ...
        var addVertex2 = function (icon, w, h, style) {
            ...
            var img = addToolbarItem(graph, toolbar, person1, icon);
            img.enabled = true;
        ...
        addVertex2('assets/img/cc.gif', 100, 60, 'rounded=0;fillColor=#EEEEEE;strokeColor=#333333');
